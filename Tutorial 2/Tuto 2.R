...
print(sales_fact)                             # printing all available rows
print(head(sales_fact))                       # printing only first 6 rows using command'head'
print(tail(sales_fact))                       # printing only last 6 rows using command 'tail'
print(summary(sales_fact))                    # summarizes ur data frame
